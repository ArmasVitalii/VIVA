...
std::vector<std::shared_ptr<AbstractMagic>> MagicDistributor::generateMagicPowers(bool hasIllusions)
{
    ...
    magicPowers.push_back(std::make_shared<FromAshes>());
    ...
    magicPowers.push_back(std::make_shared<WaterVortex>());
    magicPowers.push_back(std::make_shared<Tsunami>());
    ...
    magicPowers.push_back(std::make_shared<Borders>());
    magicPowers.push_back(std::make_shared<Avalanche>());
